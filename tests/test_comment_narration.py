...
The comment rule says a comment states a decision or a constraint,
...
# (filename, verbatim text). Kept empty on purpose: the one hit the scan found
# on adoption was reworded, not exempted.
EXEMPTIONS: set = set()
